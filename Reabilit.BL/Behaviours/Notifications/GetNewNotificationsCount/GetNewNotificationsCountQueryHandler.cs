...
public class GetNewNotificationsCountQueryHandler : IRequestHandler<GetNewNotificationsCountQuery, List<ProcedureEventNotificationDTO>>
{
    private readonly DataContext _context;

    public GetNewNotificationsCountQueryHandler(DataContext context)
    {
        _context = context;
    }

    public async Task<List<ProcedureEventNotificationDTO>> Handle(GetNewNotificationsCountQuery request, CancellationToken cancellationToken)
    {
